...
\improvi{Interpret the performance and resource usage values?
(for single test vector etc.)}

Running RTL co-simulation with all 2000 test vectors and this order of latency will be very time-consuming and not very useful. Therefore, only C simulation was used to ensure the correctness of the unoptimised design. RTL co-simulations were still used in later optimised design.
...
\improvi{Explain the ARM core and SoC somewhere before this section}
