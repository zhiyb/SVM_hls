...
\begin{figure}[ht]
	...
	\caption{Latency and resource usage vs loop unrolling}
	\label{fig:latency}
\end{figure}
...
After multiple optimisations, the improved IP core will be packaged in Vivado and set up in SDK as the procedure in previous dot product exercise. 
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.3\columnwidth]{sdk}
	\caption{Flow chart of SDK implementation}
	\label{fig:ip}
\end{figure}
